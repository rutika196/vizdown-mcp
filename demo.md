# Clarity-beta — Diagram Gallery

> Every diagram below was generated from plain Markdown using Clarity-beta.
...
2. Clarity-beta auto-detects the diagram type and picks the right renderer
...
```
You → Markdown → Clarity-beta → SVG/PNG/PDF
```
...
*Generated by [Clarity-beta](https://github.com/rutika196/clarity-beta)*
